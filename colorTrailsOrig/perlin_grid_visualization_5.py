...
def main() -> None:
    ...
    emitter_gap = 6
    emitter_btn_w = (RIGHT_UI_WIDTH - 40 - emitter_gap * 2) // 3
    emitter_line_button = Button("Line", pygame.Rect(ui_x + 20, MARGIN + 58, emitter_btn_w, 28), active=True)
    emitter_dots_button = Button("Orbiting dots", pygame.Rect(ui_x + 20 + emitter_btn_w + emitter_gap, MARGIN + 58, emitter_btn_w, 28), active=False)
    ...
    while running:
        ...
        screen.blit(mode_header, (panel_rect.left + 20, MARGIN + 334))
